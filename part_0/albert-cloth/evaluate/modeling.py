...
class AlbertForCloth(AlbertPreTrainedModel):
    ...
    def accuracy(self, out, tgt):
        ...
        print(out)
        # print(out[0:100])
        # torch.save(out, 'guess' + str(self.count) + '.pt')
        # self.count += 1
        # print("\033[1;32m", len(out), "\033[0;37m")
...
if __name__ == '__main__':
    ...
    tgt = ans
    model = AlbertForCloth.from_pretrained('/chpc/home/stu-ysfang-a/ALBERT-data/albert-xxlarge-v2', cache_dir=PYTORCH_PRETRAINED_BERT_CACHE / 'distributed_{}'.format(-1))
