...
from transformers.file_utils import cached_path, PYTORCH_PRETRAINED_XLNET_CACHE, add_start_docstrings
from transformers.modeling_xlnet import XLNetModel, XLNetPreTrainedModel, XLNetMLMHead
...
class XLNetForCloth(XLNetPreTrainedModel):
